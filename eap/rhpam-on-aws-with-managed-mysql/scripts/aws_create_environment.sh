...
echo ""
echo "** tip: if you opt for a managed db instance, once it's up (it can take a couple of minutes), get its address:"
echo "** aws rds describe-db-instances --db-instance-identifier rhpam-mysql-db --query DBInstances[].Endpoint.Address"
